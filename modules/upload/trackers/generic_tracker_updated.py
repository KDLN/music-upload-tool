...
class GenericTracker:
    ...
    def __init__(self, config: Dict[str, Any], tracker_id: str):
        ...
        # Get cover art field name (defaults to "image" if not specified)
        self.cover_field_name = tr_cfg.get('cover_field_name', 'image')
    ...
    def _log_config(self):
        ...
        logger.info(f"[{self.tracker_id} CONFIG] " 
                   ...
                   f"cover_field_name={self.cover_field_name}")
    ...
    def _build_file_payload(self, torrent_path: str, cover_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        # Add cover file to upload if found - use configured field name
        if cover_path and os.path.exists(cover_path):
            try:
                ...
                # Use the tracker-specific cover field name from configuration
                field_name = self.cover_field_name
                ...
                logger.info(f"Added cover art to tracker upload using field name '{field_name}': {cover_path}")
            except Exception as e:
