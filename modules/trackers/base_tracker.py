"""
Base tracker module for Music-Upload-Tool.
Provides a common interface for all tracker implementations.
"""
...
class BaseTracker:
    ...
    def __init__(self, config: Dict[str, Any], tracker_id: str):
        ...
        self.session.headers.update({
            'User-Agent': f"Music-Upload-Tool/{config.get('app_version', '1.0.0')}",
    ...
    def upload(self, torrent_path: str, description: str, metadata: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        return False, "Upload not implemented in base tracker"
